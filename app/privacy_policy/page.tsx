      ...
      <div className="flex justify-center py-10">
        <Link href="/">
          <FadeImg
            ...
            width={340}
            height={18}
            className="min-w-[226px] w-[226px] md:w-full md:max-w-[340px]"
            quality={100}
          />
        </Link>
      </div>
      <div className="container px-4 mx-auto mt-10 mb-[100px] privacy">
        ...
        <div className="roboto flex flex-col gap-5">
          <p>
            ООО «Кеду Медиа» (далее - Кеду Медиа, мы, наш, наши), ИНН,
            9725026154, зарегистрированное по адресу Российская Федерация, город
            Москва, проезд Проектируемый 4062-й, дом 6, строение 16, комната 9,
            этаж 3, придаёт большое значение защите и безопасности персональных
            данных.
          </p>
          <p>
          ...
          <p>
            ...
            обрабатываемых Кеду Медиа. Мы постарались сделать Политику
          ...
          <p>
            ...
            <Link href="mailto:info@kedoomedia.ru">info@kedoomedia.ru</Link>
          </p>
          ...
          <p>
            ...
            Москва, проезд Проектируемый 4062-й, дом 6, строение 16, комната 9,
            этаж 3, указав в нем сведения о документе, удостоверяющем Вашу
          ...
          <p>
            ...
            ответственному за организацию обработки: Прохоров Виталий
            Викторович. Электронный адрес:{" "}
            <Link href="mailto:info@kedoomedia.ru">info@kedoomedia.ru</Link>{" "}
            Последнее обновление: 21 декабря 2024 г.
          </p>
        </div>
      </div>
    </section>
